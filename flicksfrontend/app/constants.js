define({
  ...
  links: {
    ...
    kg_id:      'https://karagarga.in/details.php?id=%d',
    kg_imdb:    'https://karagarga.in/browse.php?search_type=imdb&search=%07d',
    kg_title:   'https://karagarga.in/browse.php?search_type=title&search=%s',
