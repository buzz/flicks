...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.audio_channels'
        db.alter_column(u'flicksapp_track', 'audio_channels', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Track.video_height'
        db.alter_column(u'flicksapp_track', 'video_height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Track.stream_size'
        db.alter_column(u'flicksapp_track', 'stream_size', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Track.video_width'
        db.alter_column(u'flicksapp_track', 'video_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'File.file_size'
        db.alter_column(u'flicksapp_file', 'file_size', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Track.audio_channels'
        db.alter_column(u'flicksapp_track', 'audio_channels', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Track.video_height'
        db.alter_column(u'flicksapp_track', 'video_height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Track.stream_size'
        db.alter_column(u'flicksapp_track', 'stream_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Track.video_width'
        db.alter_column(u'flicksapp_track', 'video_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'File.file_size'
        db.alter_column(u'flicksapp_file', 'file_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
