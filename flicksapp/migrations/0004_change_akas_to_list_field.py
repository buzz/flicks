...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Movie.akas'
        db.alter_column('flicksapp_movie', 'akas', self.gf('flicksapp.fields.ListField')())

    def backwards(self, orm):

        # Changing field 'Movie.akas'
        db.alter_column('flicksapp_movie', 'akas', self.gf('django.db.models.fields.TextField')())
