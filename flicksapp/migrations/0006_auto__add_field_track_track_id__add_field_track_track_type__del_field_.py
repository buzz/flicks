...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.track_id'
        db.add_column(u'flicksapp_track', 'track_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Track.track_type'
        db.add_column(u'flicksapp_track', 'track_type',
                      self.gf('django.db.models.fields.CharField')(default='V', max_length=1),
                      keep_default=False)

        # Deleting field 'File.container_format_info'
        db.delete_column(u'flicksapp_file', 'container_format_info')

        # Deleting field 'File.filetype'
        db.delete_column(u'flicksapp_file', 'filetype')

        # Adding field 'File.file_type'
        db.add_column(u'flicksapp_file', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default='V', max_length=1),
                      keep_default=False)

        # Adding field 'File.file_output'
        db.add_column(u'flicksapp_file', 'file_output',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.track_id'
        db.delete_column(u'flicksapp_track', 'track_id')

        # Deleting field 'Track.track_type'
        db.delete_column(u'flicksapp_track', 'track_type')

        # Adding field 'File.container_format_info'
        db.add_column(u'flicksapp_file', 'container_format_info',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'File.filetype'
        db.add_column(u'flicksapp_file', 'filetype',
                      self.gf('django.db.models.fields.CharField')(default='V', max_length=1),
                      keep_default=False)

        # Deleting field 'File.file_type'
        db.delete_column(u'flicksapp_file', 'file_type')

        # Deleting field 'File.file_output'
        db.delete_column(u'flicksapp_file', 'file_output')
